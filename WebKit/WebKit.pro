...
CONFIG += ordered
QMAKEPATH = $$(QMAKEPATH)
isEmpty(QMAKEPATH)|!exists($${QMAKEPATH}/mkspecs):error("The environment variable QMAKEPATH needs to point to $WEBKITSRC/Tools/qmake")
...
SUBDIRS += QtWebKit
SUBDIRS += Tools
OTHER_FILES = Tools/qmake/README \
