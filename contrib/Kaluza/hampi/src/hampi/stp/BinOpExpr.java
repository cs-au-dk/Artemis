...
public final class BinOpExpr extends STPExpr{
  ...
  public void toSTPString(int shift){
	...
	switch(binopKind){
	case EQ_OP:
		//b.append(e1.toSTPString(shift));
		e1.toSTPString(shift);
		System.err.print("=");
		//b.append("=");
		//b.append(e2.toSTPString(shift));
		e2.toSTPString(shift);
		break;

	default: switch(binopKind){
				case GE_OP : System.err.print("BVGE("); break;
				case GT_OP : System.err.print("BVGT("); break;
				case LE_OP : System.err.print("BVLE(");break;
				case LT_OP : System.err.print("BVLT(");break;
      case EQ_OP:
        break;
			}
			//b.append(e1.toSTPString(shift));
