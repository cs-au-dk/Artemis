...
*/
qx.Class.define('eyeos.suhandlers.ShareFolder', {
...
* must display the words "Powered by eyeos" and retain the original copyright notice.
*/
qx.Class.define('eyeos.suhandlers.WorkgroupFolder', {
	extend: eyeos.files.ASocialBarHandler,
	implement: [eyeos.files.ISocialBarHandler],

	statics: {
		checkHandler: function (params) {
			return eyeos.files.SUPathManager.isWorkgroupPath(params['path']);
		}
	},
	members: {
		updateSocialBar: function (s) {
			this.getSocialBar().createDefaultTabs();
			this.getSocialBar().removeTab('Share');
		}
	}
...
* must display the words "Powered by eyeos" and retain the original copyright notice.
*/
qx.Class.define('eyeos.suhandlers.WorkgroupFile', {
	extend: eyeos.files.ASocialBarHandler,
	implement: [eyeos.files.ISocialBarHandler],
