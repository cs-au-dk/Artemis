...
Z3_bool cb_reduce_app(Z3_theory t, Z3_func_decl d, unsigned n, Z3_ast const * args,
    Z3_ast * result);
...
void addAxiomInSearch(Z3_theory t, Z3_ast toAssert, int line, bool display = true);
