    ...
    for line in linesInFile:
        ...
        while True:
            ...
            while (not (p2 == -1)) and (not line[p2 - 2] == '\\') and line[p2 - 1] == '\\' and line[p2] == '\"':
                p2 = line.find('\"', p2 + 1)
            #print "** line[p2-1] = " + line[p2-1]
            #print "** line[p2] = " + line[p2]
...
if __name__ == '__main__':
    ...
    try:
        ...
        sys.stderr.write("Z3-str.py: Received OSError, this might be caused by missing executable. \nPlease try and \"make constraintsolver\".")
        exit(1)
