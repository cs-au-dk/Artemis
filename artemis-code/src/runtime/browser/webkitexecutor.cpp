    ...
    mKeepOpen(false)
{
    ...
    QObject::connect(webkitListener, SIGNAL(sigJavascriptBytecodeExecuted(QString, bool, uint,  uint, QSource*)),
                     mCoverageListener.data(), SLOT(slJavascriptBytecodeExecuted(QString, bool, uint, uint, QSource*)));
    ...
    QObject::connect(webkitListener, SIGNAL(sigJavascriptBytecodeExecuted(QString, bool, uint,  uint, QSource*)),
                     mPathTracer.data(), SLOT(slJavascriptBytecodeExecuted(QString, bool, uint, uint, QSource*)));
    QObject::connect(webkitListener, SIGNAL(sigJavascriptFunctionCalled(QString, size_t, uint, uint, QSource*)),
