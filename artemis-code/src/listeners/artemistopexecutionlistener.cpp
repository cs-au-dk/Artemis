...
void ArtemisTopExecutionListener::before_execute(ExecutableConfiguration* conf, ExecutorState* exe_state) {}
void ArtemisTopExecutionListener::executed(ExecutableConfiguration* conf, ExecutorState* exe_state, const ExecutionResult& result) {}
