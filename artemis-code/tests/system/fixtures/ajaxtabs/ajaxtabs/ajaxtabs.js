...
ddajaxtabs.prototype={
	...
	iframedisplay:function(pageurl, contentdivid){
		...
		//console.log(">>>4" + this.defaultIframe)
		document.getElementById(contentdivid).innerHTML=""
		//console.log(">>>5 " + document.getElementById(contentdivid).innerHTML)
	//	alert(">>>3 " + window.frames["_ddajaxtabsiframe-"+contentdivid] + "_ddajaxtabsiframe-"+contentdivid)
